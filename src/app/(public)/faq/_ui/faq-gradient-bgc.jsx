...
const GradientBackground = ({ position }) => {
  ...
  return (
    <div className={style}>
      <div
        className={`relative ${position === 'top' ? 'left-[calc(50%-11rem)]' : 'left-[calc(110%-11rem)]'} aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:${position === 'top' ? 'left-[calc(50%-30rem)]' : 'left-[calc(60%-30rem)]'} sm:w-[72.1875rem]`}
        style={{ clipPath }}
      />
    </div>
  );
