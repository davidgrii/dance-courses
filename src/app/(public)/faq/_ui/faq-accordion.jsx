  ...
  return (
    <Accordion type='single' collapsible className='w-full text-left flex flex-col gap-3'>
      ...
      <AccordionItem value='item-2'>
        <AccordionTrigger>What are the practices based on?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value='item-3'>
        <AccordionTrigger>
          How can I participate in the Jazzo Community?
        </AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value='item-4'>
        <AccordionTrigger>
          Where is Jazzo practiced? (everywhere!)
        </AccordionTrigger>
        <AccordionContent>
          Yes. It&apos;s animated by default, but you can disable it if you
          prefer.
      ...
      <AccordionItem value='item-5'>
        <AccordionTrigger>
          Where does the Philosophy of Jazzo come from?
        </AccordionTrigger>
        <AccordionContent>
          Yes. It&apos;s animated by default, but you can disable it if you
          prefer.
